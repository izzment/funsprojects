...
const FeaturedPosts = () => {
    return (
        <div className='mt-8 flex flex-col lg:flex-row gap-8 mx-32'>
            {/* first */}
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-4">
                ...
                <div className="lg:h-1/3 flex justify-between gap-4">
                    ...
                    <div className="w-2/3">
                        ...
                        {/* title */}
                        <div className="text-base sm:text-lg md:text-2xl lg:text-xl xl:text-2xl font-medium">Lorem ipsum dolor sit amet consectetur, adipisicing elit.</div>
                    </div>
                </div>
                {/* third */}
                <div className="lg:h-1/3 flex justify-between gap-4">
